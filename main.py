...
def index():
    ...
    #except:
    #  total_emissions = 0
    return render_template('index.html', n_flights = flights_in_db, total_em=total_emissions)
...
def single():
      ...
      if (og_air is not None) & (de_air is not None):
            ...
            emiss = ''
      # Set The upload HTML template '\templates\index.html'
      return render_template('single.html', emiss_out=emiss, air_codes=iata_codes)
